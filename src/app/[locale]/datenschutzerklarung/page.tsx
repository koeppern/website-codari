...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `/${locale}/datenschutzerklarung`,
      languages: { de: "/de/datenschutzerklarung", en: "/en/datenschutzerklarung" },
    },
...
export default async function DatenschutzPage({
  ...
  const jsonLd = JSON.stringify(
    breadcrumbJsonLd([{ name: "Datenschutzerklärung", href: "/datenschutzerklarung" }])
  );
    ...
    <>
      ...
      <section className="bg-background py-24">
        <div className="mx-auto max-w-3xl px-6">
          <h1 className="mb-12 text-4xl font-bold text-foreground">Datenschutzerklärung</h1>

          <div className="prose max-w-none space-y-8 text-muted [&_h2]:mb-4 [&_h2]:mt-12 [&_h2]:text-xl [&_h2]:font-semibold [&_h2]:text-foreground [&_h3]:mb-3 [&_h3]:mt-6 [&_h3]:text-lg [&_h3]:font-semibold [&_h3]:text-foreground [&_p]:mb-4">
            <p>
            ...
            <ul className="ml-6 list-disc space-y-2">
              <li><strong className="text-foreground">Personenbezogene Daten:</strong> Alle Informationen, die sich auf eine identifizierte oder identifizierbare natürliche Person beziehen.</li>
              <li><strong className="text-foreground">Betroffene Person:</strong> Jede identifizierte oder identifizierbare natürliche Person, deren personenbezogene Daten verarbeitet werden.</li>
              <li><strong className="text-foreground">Verarbeitung:</strong> Jeder mit oder ohne Hilfe automatisierter Verfahren ausgeführte Vorgang im Zusammenhang mit personenbezogenen Daten.</li>
              <li><strong className="text-foreground">Verantwortlicher:</strong> Die natürliche oder juristische Person, die über die Zwecke und Mittel der Verarbeitung von personenbezogenen Daten entscheidet.</li>
            </ul>

            <h2>2. Name und Anschrift des Verantwortlichen</h2>
            <p>CODARI GbR<br />Eichendorffstraße 38<br />47800 Krefeld<br />Deutschland</p>
            <p>Telefon: +49 2151 6476293<br />E-Mail: info@codari.de<br />Website: www.codari.de</p>
